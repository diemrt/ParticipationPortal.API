    ...
    public partial class InitalCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_weekly_event_role", x => x.Id);
                    table.ForeignKey(
                        name: "FK_weekly_event_role_role_role_id",
                        column: x => x.role_id,
                        principalSchema: "dbo",
                        principalTable: "role",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_weekly_event_role_weekly_event_weekly_event_id",
                        column: x => x.weekly_event_id,
                        principalSchema: "dbo",
                        principalTable: "weekly_event",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_weekly_event_role_role_id",
                schema: "dbo",
                table: "weekly_event_role",
                column: "role_id");

            migrationBuilder.CreateIndex(
                name: "IX_weekly_event_role_weekly_event_id",
                schema: "dbo",
                table: "weekly_event_role",
                column: "weekly_event_id");
        }
